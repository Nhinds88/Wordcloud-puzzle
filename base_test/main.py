...
for i in range(1):
    ...
    while True:
        try:
            ...
            #plot for edge detection 
            # plt.figure(figsize=(10, 10))
            # plt.imshow(wc, interpolation="bilinear")

            # plt.figure(figsize=(10, 10))
            # plt.title("Original Image")
            # plt.imshow(image_coloring)
